...
print(ggplot(base,aes(x=year,y=country,fill=data_available)) + geom_tile(data = subset(base, !is.na(data_available)))  + scale_fill_manual(values=c("#008000", NA)))
```
...
base$data_available <- a
base$data_available <- gsub('FALSE', NA, base$data_available)
print(ggplot(base,aes(x=year,y=country,fill=data_available)) + geom_tile(data = subset(base, !is.na(data_available)))  + scale_fill_manual(values=c("#6a3d9a", NA)))
```
...
base$data_available <- a
base$data_available <- gsub('FALSE', NA, base$data_available)
print(ggplot(base,aes(x=year,y=country,fill=data_available)) + geom_tile(data = subset(base, !is.na(data_available))) + scale_fill_manual(values=c("#e31a1c", NA)))
```
...
base$data_available <- a
base$data_available <- gsub('FALSE', NA, base$data_available)
print(ggplot(base,aes(x=year,y=country,fill=data_available)) + geom_tile(data = subset(base, !is.na(data_available))) + scale_fill_manual(values=c("#FF9912", NA)))
```
...
base$data_available <- a
base$data_available <- gsub('FALSE', NA, base$data_available)
print(ggplot(base,aes(x=year,y=country,fill=data_available)) + geom_tile(data = subset(base, !is.na(data_available))) + scale_fill_manual(values=c("#104E8B", NA)))
```