...
var series = [
    {
        key: "Gini coefficient - Per capita household consumption", // XXX
        values: [],
    ...
    {
        key: "Share of top 1% - Pre-tax fiscal income (equal-split adults) (excluding capital gains)", // XXX
        values: [],
        color: topincomecolor
    },

    {
        key: "Share below absolute poverty line (Lakdawala methodology) - Per capita household consumption", // XXX
        values: [],
        color: povertycolor
    },
    {
        key: "Share below absolute poverty line (Tendulkar methodology) - Per capita household consumption", // XXX
        values: [],
        color: povertycolor
    },
    {
        key: "Share below absolute poverty line (Rangarajan methodology) - Per capita household consumption", // XXX
        values: [],
        color: povertycolor
    },
    {
        key: "Gini coefficient - Daily individual earnings of regular workers", // XXX
        values: [],
        color: earningscolor
    },
    {
        key: "Share of top 1% - Individual net wealth", // XXX
        values: [],
        color: wealthcolor
    },
];
...
AddToChart1
    .append("text")
    .text("Economic Inequality in India")  // XXX
    .attr("x", 500)
    .attr("y", 28)
...
c3.select('#chart2')
    ...
    .style("fill", earningscolor)
    .text("Gini coefficient - Daily individual earnings")
    .attr("x", 325)
    .attr("y", 125);
c3.select('#chart2')
    .append("text")
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", overallinequalitycolor)
    .text("Gini coefficient - Per capita household consumption")
    .attr("x", 760)
    .attr("y", 152);
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", povertycolor)
    .text("Share below absolute poverty line (Tendulkar)")
    .attr("x", 760)
    .attr("y", 225);
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", povertycolor)
    .text("Share below absolute poverty line (Rangajaran)")
    .attr("x", 760)
    .attr("y", 205);
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", povertycolor)
    .text("Share below absolute poverty line (Lakdawla)")
    .attr("x", 245)
    .attr("y", 55);
