...
var top_series = [
    {
        key: "Top decile as % median - Gross individual earnings",
        values: [],
        color: earningscolor
    }
]

var RH_tickMarks = [180, 190, 200, 210, 220, 230, 240, 250, 260, 270, 280] // XXX    100,110,120,130,140,150,160,170,180,190,200,210,220,230,240,250,260,270,280,290,300
...
var series = [
    {
        key: "Gini coefficient - Equivalised disposable household income (series 3)",
        values: [],
...
AddToChart1
    .append("text")
    .text("Economic Inequality in Portugal")  // XXX
    .attr("x", 500)
    .attr("y", 28)
...
c3.csv("../raw_df.csv", function (data) {
    c3.select('#chart1')
        ...
        .text(data.find(object => {
            return (object["country"] === "Portugal" && object["dimension"] === "Earnings Dispersion" && object["description"] != "")
        })["legend"]) // XXX
        .attr("x", 760)
        .attr("y", 120);
})
