...
var RH_tickMarks = [170, 180, 190, 200, 210, 220, 230, 240] // XXX    100,110,120,130,140,150,160,170,180,190,200,210,220,230,240,250,260,270,280,290,300
...
AddToChart1
    .append("text")
    .text("Economic Inequality in Japan")  // XXX
    .attr("x", 500)
    .attr("y", 28)
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", overallinequalitycolor)
    .text("Gini coefficient - Gross househould income")
    .attr("x", 280)
    .attr("y", 133);
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", wealthcolor)
    .text("Gini coefficient - Net wealth")
    .attr("x", 585)
    .attr("y", 60);
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", wealthcolor)
    .text("Share of top 1% - Net household financial wealth")
    .attr("x", 760)
    .attr("y", 328);
