...
var RH_tickMarks = [140, 150, 160, 170, 180, 190] // XXX    100,110,120,130,140,150,160,170,180,190,200,210,220,230,240,250,260,270,280,290,300
...
AddToChart1
    .append("text")
    .text("Economic Inequality in New Zealand")  // XXX
    .attr("x", 500)
    .attr("y", 28)
