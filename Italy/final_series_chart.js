        ...
        c3.csv("../raw_df.csv", function (data) {
            c3.select('#chart1')
                ...
                .text(data.find(object => {
                    return (object["country"] === "Italy" && object["dimension"] === "Earnings Dispersion" && object["description"] != "")
                })["legend"]) // XXX
                .attr("x", 760)
                .attr("y", 142);
        })
        ...
        c3.select('#chart2')
            ...
            .attr("class", "linelabel")
            .style("fill", color_ref['O'])
            .text("Gini coefficient - Income per capita")
            .attr("x", 760)
            .attr("y", 128);
        ...
        c3.select('#chart2')
            ...
            .attr("class", "linelabel")
            .style("fill", color_ref['T'])
            .text("Share of top 1% - Pre-tax national income (equal-split adults)")
            .attr("x", 760)
            .attr("y", 303);
        c3.select('#chart2')
            .append("text")
        ...
        c3.select('#chart2')
            ...
            .attr("class", "linelabel")
            .style("fill", color_ref['W'])
            .text("Share of top 1% - Total equivalised net wealth")
            .attr("x", 760)
            .attr("y", 257);
