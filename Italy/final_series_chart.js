...
var RH_tickMarks = [140, 150, 160, 170, 180] // XXX    100,110,120,130,140,150,160,170,180,190,200,210,220,230,240,250,260,270,280,290,300
...
var series = [
    {
        key: "Gini coefficient - Per capita income", // XXX
        values: [],
    ...
    {
        key: "Share of top 1% - Post-tax national income (equal-split adults)", // XXX
        values: [],
        color: topincomecolor
    },
    {
    ...
    {
        key: "Share of top 1% - Equivalised net wealth", // XXX
        values: [],
        color: wealthcolor
    },
    {
        key: "Share of top 10% - Household net wealth", // XXX
        values: [],
        color: wealthcolor
    },
]
...
AddToChart1
    .append("text")
    .text("Economic Inequality in Italy")  // XXX
    .attr("x", 500)
    .attr("y", 28)
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", wealthcolor)
    .text("Share of top 1% - Equivalised net wealth ★")
    .attr("x", 760)
    .attr("y", 286);
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", wealthcolor)
    .text("Share of top 10% - Household net wealth ★")
    .attr("x", 760)
    .attr("y", 140);
