...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", topincomecolor)
    .text("Share of top 1% - Share of top 1% - Pre-tax") // XXX 
    .attr("x", 105) // XXX 
    .attr("y", 320); // XXX 
c3.select('#chart2')
    .append("text")
    .attr("class", "linelabel")
    .style("fill", topincomecolor)
    .text("fiscal income (tax units, excluding capital gains) ★") // XXX 
    .attr("x", 105) // XXX 
    .attr("y", 330); // XXX 
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", wealthcolor)
    .text("Share of top 1% - Household net wealth ★") // XXX 
    .attr("x", 290) // XXX
    .attr("y", 186); // XXX
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", wealthcolor)
    .text("Gini coefficient - Household net wealth ★") // XXX 
    .attr("x", 760) // XXX
    .attr("y", 65); // XXX
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", wealthcolor)
    .text("Share of top 1% - Net wealth (equal-slit adults) ★") // XXX 
    .attr("x", 760) // XXX
    .attr("y", 292); // XXX
