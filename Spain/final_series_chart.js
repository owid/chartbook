        ...
        AddToChart1
            .append("text")
            .text("Economic Inequality in Spain")  // XXX
            .attr("x", 500)
            .attr("y", 28)
        ...
        c3.csv("../raw_df.csv", function (data) {
            c3.select('#chart1')
                ...
                .text(data.find(object => {
                    return (object["country"] === "Spain" && object["dimension"] === "Earnings Dispersion" && object["description"] != "")
                })["legend"]) // XXX
                .attr("x", 760)
                .attr("y", 103);
        })
        ...
        c3.select('#chart2')
            ...
            .attr("class", "linelabel")
            .style("fill", color_ref['W'])
            .text("Share of top 1% - Individual net estates")
            .attr("x", 260)
            .attr("y", 105);
