...
var RH_tickMarks = [150, 160, 170, 180, 190, 200] // XXX    100,110,120,130,140,150,160,170,180,190,200,210,220,230,240,250,260,270,280,290,300
...
var series = [
    ...
    {
        key: "Gini coefficient - Per capita net wealth",
        values: [],
        color: wealthcolor
    },
]
...
AddToChart1
    .append("text")
    .text("Economic Inequality in Germany")  // XXX
    .attr("x", 500)
    .attr("y", 28)
...
c3.select('#chart2')
    ...
    .attr("class", "linelabel")
    .style("fill", wealthcolor)
    .text("Gini coefficient - Per capita net wealth ★")
    .attr("x", 760)
    .attr("y", 88);
