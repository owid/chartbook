...
var series = [
    {
        key: "Gini coefficient - Househould income", // XXX
        values: [],
    ...
    {
        key: "Share of bottom 40% - Gross household income", // XXX
        values: [],
        color: povertycolor
    },

    {
        key: "Share below absolute poverty line (PLI 2004) - Household income", // XXX
        values: [],
        color: povertycolor
    }
];
...
c3.csv("../raw_df.csv", function (data) {
    c3.select('#chart2')
        ...
        .attr("class", "linelabel")
        .style("fill", povertycolor)
        .text("Share of bottom 40% - Gross household income") // XXX
        .attr("x", 755)
        .attr("y", 275);
})
...
c3.csv("../raw_df.csv", function (data) {
    c3.select('#chart2')
        ...
        .attr("class", "linelabel")
        .style("fill", povertycolor)
        .text("Share below absolute poverty line") // XXX
        .attr("x", 755)
        .attr("y", 345);
    c3.select('#chart2')
        .append("text")
        .attr("class", "linelabel")
        .style("fill", povertycolor)
        .text("(PLI 2004) - Household income") // XXX
        .attr("x", 755)
        .attr("y", 355);
})
