    ...
    $scope.data1 = [
        {
            key: 'Chartbook series', type: 'line', values: [
                ...
                { 'x': 2019, 'y': 14.87, 'series': 0 },
                { 'x': 2020, 'y': 14.87, 'series': 0 }], yAxis: 1
        },
        {
            key: 'WID - Pre-tax national income (equal-split adults)', type: 'scatter', values: [
                ...
                { 'x': 2019, 'y': 14.87, 'series': 1 },
                { 'x': 2020, 'y': 14.87, 'series': 1 }], yAxis: 1
        }];
    $scope.data2 = [
        {
            key: 'Chartbook series', type: 'line', values: [
                { 'x': 1951, 'y': 8.76, 'series': 0 },
                { 'x': 1955, 'y': 1.14, 'series': 0 },
                { 'x': 1956, 'y': 1.48, 'series': 0 },
                { 'x': 1957, 'y': 1.27, 'series': 0 },
                { 'x': 1958, 'y': 1.67, 'series': 0 },
                { 'x': 1959, 'y': 1.64, 'series': 0 },
                { 'x': 1960, 'y': 1.81, 'series': 0 },
                { 'x': 1961, 'y': 11.87, 'series': 0 },
                { 'x': 1962, 'y': 11.7, 'series': 0 },
                { 'x': 1963, 'y': 11.64, 'series': 0 },
                { 'x': 1964, 'y': 12.2, 'series': 0 },
                { 'x': 1965, 'y': 12.99, 'series': 0 },
                { 'x': 1966, 'y': 1.86, 'series': 0 },
                { 'x': 1967, 'y': 1.72, 'series': 0 },
                { 'x': 1968, 'y': 11.7, 'series': 0 },
                { 'x': 1969, 'y': 11.28, 'series': 0 },
                { 'x': 1970, 'y': 14.81, 'series': 0 },
                { 'x': 1971, 'y': 15.14, 'series': 0 },
                { 'x': 1972, 'y': 18.51, 'series': 0 },
                { 'x': 1973, 'y': 17.49, 'series': 0 },
                { 'x': 1974, 'y': 15.3, 'series': 0 },
                { 'x': 1975, 'y': 16.3, 'series': 0 },
                { 'x': 1983, 'y': 12.32, 'series': 0 },
                { 'x': 1984, 'y': 11.59, 'series': 0 },
                { 'x': 1989, 'y': 1.78, 'series': 0 },
                { 'x': 1997, 'y': 12.35, 'series': 0 },
                { 'x': 2002, 'y': 12.36, 'series': 0 },
                { 'x': 2004, 'y': 11.91, 'series': 0 },
                { 'x': 2007, 'y': 16.4, 'series': 0 },
                { 'x': 2009, 'y': 13.85, 'series': 0 },
                { 'x': 2012, 'y': 13.58, 'series': 0 },
                { 'x': 2014, 'y': 13.47, 'series': 0 }], yAxis: 1
        },
        {
            key: 'WID - Pre-tax fiscal income (equal-split adults)', type: 'scatter', values: [
                { 'x': 1951, 'y': 8.76, 'series': 1 },
                { 'x': 1955, 'y': 1.14, 'series': 1 },
                { 'x': 1956, 'y': 1.48, 'series': 1 },
                { 'x': 1957, 'y': 1.27, 'series': 1 },
                { 'x': 1958, 'y': 1.67, 'series': 1 },
                { 'x': 1959, 'y': 1.64, 'series': 1 },
                { 'x': 1960, 'y': 1.81, 'series': 1 },
                { 'x': 1961, 'y': 11.87, 'series': 1 },
                { 'x': 1962, 'y': 11.7, 'series': 1 },
                { 'x': 1963, 'y': 11.64, 'series': 1 },
                { 'x': 1964, 'y': 12.2, 'series': 1 },
                { 'x': 1965, 'y': 12.99, 'series': 1 },
                { 'x': 1966, 'y': 1.86, 'series': 1 },
                { 'x': 1967, 'y': 1.72, 'series': 1 },
                { 'x': 1968, 'y': 11.7, 'series': 1 },
                { 'x': 1969, 'y': 11.28, 'series': 1 },
                { 'x': 1970, 'y': 14.81, 'series': 1 },
                { 'x': 1971, 'y': 15.14, 'series': 1 },
                { 'x': 1972, 'y': 18.51, 'series': 1 },
                { 'x': 1973, 'y': 17.49, 'series': 1 },
                { 'x': 1974, 'y': 15.3, 'series': 1 },
                { 'x': 1975, 'y': 16.3, 'series': 1 },
                { 'x': 1983, 'y': 12.32, 'series': 1 },
                { 'x': 1984, 'y': 11.59, 'series': 1 },
                { 'x': 1989, 'y': 1.78, 'series': 1 },
                { 'x': 1997, 'y': 12.35, 'series': 1 },
                { 'x': 2002, 'y': 12.36, 'series': 1 },
                { 'x': 2004, 'y': 11.91, 'series': 1 },
                { 'x': 2007, 'y': 16.4, 'series': 1 },
                { 'x': 2009, 'y': 13.85, 'series': 1 },
                { 'x': 2012, 'y': 13.58, 'series': 1 },
                { 'x': 2014, 'y': 13.47, 'series': 1 }], yAxis: 1
        }];
    $scope.data3 = [
        {
            key: 'Chartbook series', type: 'line', values: [
