...
var top_series = [
    {
        key: "Top decile as % median - Annual net salary for full-time jobs", // XXX
        values: [],
        color: earningscolor
    }
]

var RH_tickMarks = [180, 190, 200, 210] // XXX    100,110,120,130,140,150,160,170,180,190,200,210,220,230,240,250,260,270,280,290,300
...
var series = [
    ...
    {
        key: "Share of top 1% - Pre-tax fiscal income (equal-split adults) (excluding capital gains)",
        values: [],
        color: topincomecolor
    },
    {
...
AddToChart1
    .append("text")
    .text("Economic Inequality in France")  // XXX
    .attr("x", 500)
    .attr("y", 28)
...
c3.csv("../raw_df.csv", function (data) {
    c3.select('#chart1')
        ...
        .style("fill", earningscolor)
        .text("Top decile as % median - Annual net salary for") // XXX
        .attr("x", 760)
        .attr("y", 105);
    c3.select('#chart1')
        .append("text")
